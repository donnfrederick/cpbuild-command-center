...
export function DesignSystemEditor() {
  ...
  useEffect(() => {
    ...
    [...primaryColors, ...secondaryColors, ...neutralColors, ...feedbackColors].forEach(
      (color) => root.style.setProperty(color.variable, color.value)
    );
  ...
  }, [primaryColors, secondaryColors, neutralColors, feedbackColors, typography]);
  ...
  const generateCSS = () => {
    let css = `:root {\n  /* CP Build Field Tracker Design System v0.1 */\n  \n  /* Font Configuration */\n  --font-size: 16px;\n  \n`;
    css += `  /* Primary Tokens */\n`;
  ...
  return (
    <div className="flex flex-1 overflow-hidden">
      ...
      <div className="flex-1 overflow-auto" style={{ padding: "var(--space-4)" }}>
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          <section>
            <h3
              className="mb-4"
              style={{ fontSize: "var(--text-heading)", fontWeight: "var(--font-weight-semibold)", color: "var(--neutral-900)" }}
            >
              Color Tokens
            </h3>
            ...
            {[
              ...
              >
                <h4
                  className="mb-4"
                  style={{ fontSize: "var(--text-subheading)", fontWeight: "var(--font-weight-medium)", color: "var(--neutral-900)" }}
                >
                  {label}
                </h4>
          ...
          <section>
            ...
            >
              <h4
                className="mb-2"
                style={{ fontSize: "var(--text-subheading)", fontWeight: "var(--font-weight-semibold)", color: "#6B21A8" }}
              >
                How to Apply Changes
              </h4>
              <ol style={{ fontSize: "var(--text-body)", color: "#6B21A8", paddingLeft: "var(--space-4)" }}>
      ...
      >
        {/* Preview header with Copy CSS button */}
        <div
        ...
        >
          <h4 style={{ fontSize: "var(--text-subheading)", fontWeight: "var(--font-weight-semibold)", color: "var(--neutral-900)" }}>
            Live Preview
          </h4>
          <button
            ...
            style={{
              ...
              backgroundColor: copied ? "var(--success-100)" : "var(--neutral-100)",
              color: copied ? "var(--success-600)" : "var(--neutral-700)",
              fontSize: "var(--text-caption)",
              fontWeight: "var(--font-weight-medium)",
              border: `1px solid ${copied ? "var(--success-600)" : "var(--neutral-300)"}`,
              cursor: "pointer",
            }}
          >
        ...
        <div className="flex-1 overflow-auto" style={{ padding: "var(--space-4)" }}>
          <div className="flex flex-col gap-4">
            ...
            <div style={{ backgroundColor: "var(--neutral-0)", padding: "var(--space-3)", borderRadius: "var(--radius-sm)" }}>
              <p className="mb-2" style={{ fontSize: "var(--text-caption)", fontWeight: "var(--font-weight-medium)", color: "var(--neutral-500)" }}>
                PRIMARY COLORS
              </p>
            ...
            <div style={{ backgroundColor: "var(--neutral-0)", padding: "var(--space-3)", borderRadius: "var(--radius-sm)" }}>
              ...
              <div className="flex flex-col gap-2">
                <h1 style={{ color: "var(--neutral-900)" }}>Display Text</h1>
                <h2 style={{ color: "var(--neutral-900)" }}>Heading Text</h2>
                <h3 style={{ color: "var(--neutral-900)" }}>Subheading Text</h3>
                <p style={{ color: "var(--neutral-900)" }}>Body text for regular content</p>
                <p style={{ fontSize: "var(--text-caption)", color: "var(--neutral-500)" }}>Caption text</p>
              </div>
            </div>
...
function ColorInput({ name, value, onChange }: { name: string; value: string; onChange: (v: string) => void }) {
  return (
    <div className="flex flex-col gap-2">
      <label style={{ fontSize: "var(--text-caption)", fontWeight: "var(--font-weight-medium)", color: "var(--neutral-500)" }}>
        {name}
      </label>
  ...
  return (
    <div className="flex items-center gap-4">
      <div style={{ width: "120px" }}>
        <p style={{ fontSize: "var(--text-body)", fontWeight: "var(--font-weight-medium)", color: "var(--neutral-900)" }}>{name}</p>
      </div>
