...
export function NotificationBell() {
  ...
  // Initial load + polling (background, silently ignores errors)
  useEffect(() => {
    let cancelled = false;
    async function poll() {
      try {
  ...
  async function markRead(id: string) {
    ...
    try {
      ...
      // optimistic update already applied — don't revert on transient failure
    }
  }
            ...
            <div style={{ flex: 1, overflowY: "auto" }}>
              {loading ? (
                ...
                >
                  <Bell
                    size={32}
                    style={{ color: "var(--neutral-300)", marginBottom: 4 }}
                  />
