...
export type FieldDailyReportPdfExportStep = "preparing" | "rendering" | "done";

const STEP_ORDER: FieldDailyReportPdfExportStep[] = ["preparing", "rendering", "done"];

const STEP_PERCENT: Record<FieldDailyReportPdfExportStep, number> = {
  preparing: 25,
  rendering: 70,
  done: 100,
};

export function FieldDailyReportPdfExportOverlay({
  step,
  projectName,
  reportDate,
  onSavePdf,
  ...
  step: FieldDailyReportPdfExportStep;
  projectName: string;
  reportDate: string;
  onSavePdf?: () => void;
  ...
  const steps: Array<{
    id: Exclude<FieldDailyReportPdfExportStep, "done">;
      ...
      >
        <div style={{ display: "flex", alignItems: "flex-start", gap: "var(--space-3)" }}>
          ...
          <div style={{ minWidth: 0, flex: 1 }}>
            ...
            >
              {t("exportPdfProgressProject", { projectName, reportDate })}
            </p>
          </div>
        </div>
